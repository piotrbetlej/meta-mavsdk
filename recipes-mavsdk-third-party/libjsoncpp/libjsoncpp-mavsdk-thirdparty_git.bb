...
EXTRA_OECMAKE += "-DCMAKE_POSITION_INDEPENDENT_CODE=ON -DBUILD_SHARED_LIBS=OFF -DJSONCPP_WITH_CMAKE_PACKAGE=ON -DJSONCPP_WITH_TESTS=OFF"

BBCLASSEXTEND = "native nativesdk"

FILES:${PN}-staticdev += "${libdir}/objects-Release/*"

#do_install:append() {
#    rm -rf ${D}${libdir}/objects-Release
#}
