...
PACKAGECONFIG ??= "pic"
PACKAGECONFIG:class-native = "ipv6 openssl-native proxy random threaded-resolver verbose zlib aws basic-auth bearer-auth digest-auth negotiate-auth"
PACKAGECONFIG:class-nativesdk = "ipv6 openssl-native proxy random threaded-resolver verbose zlib aws basic-auth bearer-auth digest-auth negotiate-auth"
...
PACKAGECONFIG[pic] = "--with-pic,--without-pic"
